package policy.aws.logmetric.cmk_changes

import data.shisho
import future.keywords

test_whether_log_metric_filter_and_alarm_exist_for_customer_cmks if {
	# check if there is a log metric filter and alarm for customer CMKs
	count([d |
		decisions[d]
	...
	# check if there is not a log metric filter and alarm for customer CMKs
	count([d |
		decisions[d]
