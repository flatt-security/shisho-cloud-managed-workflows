...
decisions[d] {
	...
	d := shisho.decision.aws.logmetric.iam_policy_changes({
		...
		"payload": shisho.decision.aws.logmetric.iam_policy_changes_payload({"cis_notification_implementations": paths}),
	})
}
