...
test_whether_log_metric_filter_and_alarm_exist_for_route_table if {
	# check if there is a log metric filter and alarm for route table changes
	count([d |
		decisions[d]
	...
	# check if there is not a log metric filter and alarm for route table changes
	count([d |
		decisions[d]
