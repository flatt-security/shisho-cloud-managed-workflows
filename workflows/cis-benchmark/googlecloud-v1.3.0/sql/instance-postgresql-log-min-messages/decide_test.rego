...
test_whether_log_min_messages_is_warning_for_postgresql_instances_of_cloud_sql if {
	# check if `log_min_messages` is set to `warning` for all PostgreSQL instances of Google Cloud SQL
	count([d |
		decisions[d]
