...
decisions[d] {
	...
	d := shisho.decision.googlecloud.logmetric.project_ownership_changes({
		...
		"payload": shisho.decision.googlecloud.logmetric.project_ownership_changes_payload({"cis_notification_implementations": paths}),
	})
}
