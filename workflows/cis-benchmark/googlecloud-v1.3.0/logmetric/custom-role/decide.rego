...
decisions[d] {
	...
	d := shisho.decision.googlecloud.logmetric.custom_role_changes({
		...
		"payload": shisho.decision.googlecloud.logmetric.custom_role_changes_payload({"cis_notification_implementations": paths}),
	})
}
...
patterns := ["resource.type=\"iam_role\" AND (protoPayload.methodName=\"google.iam.admin.v1.CreateRole\" OR protoPayload.methodName=\"google.iam.admin.v1.DeleteRole\" OR protoPayload.methodName=\"google.iam.admin.v1.UpdateRole\")"]
