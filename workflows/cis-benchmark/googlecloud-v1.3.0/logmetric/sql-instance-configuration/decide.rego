...
decisions[d] {
	...
	d := shisho.decision.googlecloud.logmetric.sql_config_changes({
		...
		"payload": shisho.decision.googlecloud.logmetric.sql_config_changes_payload({"cis_notification_implementations": paths}),
	})
}
...
patterns := ["protoPayload.methodName=\"cloudsql.instances.update\" OR protoPayload.methodName=\"cloudsql.instances.create\" OR protoPayload.methodName=\"cloudsql.instances.delete\""]
