package policy.aws.logmetric.console_auth_failure

import data.shisho
import future.keywords

test_whether_log_metric_filter_and_alarm_exist_for_console_authentication if {
	# check if there is a log metric filter and alarm for console authentication
	count([d |
		decisions[d]
	...
	# check if there is not a log metric filter and alarm for console authentication
	count([d |
		decisions[d]
