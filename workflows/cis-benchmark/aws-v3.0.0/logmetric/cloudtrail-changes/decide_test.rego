package policy.aws.logmetric.cloudtrail_changes

import data.shisho
import future.keywords

test_whether_log_metric_filter_and_alarm_exist_for_cloudtrail_configuration_changes if {
	# check if there is a log metric filter and alarm for CloudTrail configuration changes
	count([d |
		decisions[d]
	...
	# check if there is not a log metric filter and alarm for CloudTrail configuration changes
	count([d |
		decisions[d]
