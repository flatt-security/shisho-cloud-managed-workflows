package policy.aws.logmetric.vpc_changes

import data.shisho
import future.keywords

test_whether_log_metric_filter_and_alarm_exist_for_vpc if {
	# check if there is a log metric filter and alarm for VPC changes
	count([d |
		decisions[d]
	...
	# check if there is not a log metric filter and alarm for VPC changes
	count([d |
		decisions[d]
