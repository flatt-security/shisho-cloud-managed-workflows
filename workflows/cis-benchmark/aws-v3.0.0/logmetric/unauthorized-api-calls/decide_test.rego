package policy.aws.logmetric.unauthorized_api_calls

import data.shisho
import future.keywords

test_whether_log_metric_filter_and_alarm_exist_for_unauthorized_api_calls if {
	# check if there is a log metric filter and alarm for unauthorized api calls
	count([d |
		decisions[d]
	...
	# check if there is not a log metric filter and alarm for unauthorized api calls
	count([d |
		decisions[d]
