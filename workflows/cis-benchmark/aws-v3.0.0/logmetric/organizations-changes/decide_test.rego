...
test_whether_log_metric_filter_and_alarm_exist_for_organizations if {
	# check if there is a log metric filter and alarm for AWS Organizations changes
	count([d |
		decisions[d]
	...
	# check if there is not a log metric filter and alarm for AWS Organizations changes
	count([d |
		decisions[d]
