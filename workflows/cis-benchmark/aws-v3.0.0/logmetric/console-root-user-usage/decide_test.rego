package policy.aws.logmetric.console_root_user_usage

import data.shisho
import future.keywords

test_whether_log_metric_filter_and_alarm_exist_for_console_root_account_usage if {
	# check if there is a log metric filter and alarm for console root account usage
	count([d |
		decisions[d]
	...
	# check if there is not a log metric filter and alarm for console root account usage
	count([d |
		decisions[d]
