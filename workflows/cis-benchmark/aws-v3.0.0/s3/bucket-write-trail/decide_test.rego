...
test_whether_cloudtrail_logs_write_data_events_of_s3_buckets if {
	# check if the CloudTrail logs write data events of S3 buckets
	count([d |
		decisions[d]
	...
	# check if the CloudTrail does not log write data events of S3 buckets
	count([d |
		decisions[d]
