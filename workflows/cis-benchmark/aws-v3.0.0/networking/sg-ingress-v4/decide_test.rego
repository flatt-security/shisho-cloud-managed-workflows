...
test_whether_the_port_ranges_are_configured_properly_for_security_groups if {
	...
	]) == 4 with input as {"aws": {"accounts": [{"network": {
	...
	]) == 4 with input as {"aws": {"accounts": [{"network": {"networkInterfaces": [], "vpcs": [
		{
			"securityGroups": [
				{
					"metadata": {"id": "aws-vpc-secuirty-group|ap-northeast-1|vpc-0fb9667dee2b77777|sg-06f32151576611111"},
	...
	count([d |
		decisions[d]
		shisho.decision.is_allowed(d)
	]) == 1 with input as {"aws": {"accounts": [{"network": {"networkInterfaces": [], "vpcs": [{
		"securityGroups": [
			{
				"metadata": {"id": "aws-vpc-secuirty-group|ap-northeast-1|vpc-0fb9667dee2b77777|sg-06f32151576611111"},
				"name": "default",
