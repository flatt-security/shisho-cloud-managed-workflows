...
test_whether_stateless_fragment_actions_of_firewall_policies_are_allowed if {
	count([d |
		decisions[d]
		...
		{"firewalls": [{
			...
			"firewallPolicy": {"statelessFragmentDefaultActions": ["aws:drop"]},
		}]},
		{"firewalls": [{
			"metadata": {
			...
			"firewallPolicy": {"statelessFragmentDefaultActions": ["aws:forward_to_sfe"]},
		}]},
		{"firewalls": [{
			"metadata": {
...
test_whether_stateless_fragment_actions_of_firewall_policies_are_denied if {
	count([d |
		decisions[d]
		...
		{"firewalls": [{
			...
			"firewallPolicy": {"statelessFragmentDefaultActions": ["aws:pass"]},
		}]},
		{"firewalls": [{
			"metadata": {
