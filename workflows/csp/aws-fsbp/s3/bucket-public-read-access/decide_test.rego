...
test_whether_the_public_read_access_is_blocked_for_aws_s3_buckets if {
	count([d |
		decisions[d]
		...
		},
		{
			...
			"policy": {"rawDocument": "{\"Version\":\"2012-10-17\",\"Id\":\"S3-Console-Auto-Gen-Policy-1679294519317\",\"Statement\":[{\"Sid\":\"S3PolicyStmt-DO-NOT-MODIFY-1679294519221\",\"Effect\":\"Allow\",\"Principal\":{\"AWS\":\"*\"},\"Action\":\"s3:PutBucketAcl\",\"Resource\":\"arn:aws:s3:::test-bucket-8/*\"}]}"},
			"aclGrants": [{
				"grantee": {
					"type": "CANONICAL_USER",
					"uri": "",
...
test_whether_the_public_read_access_is_not_blocked_for_aws_s3_buckets if {
	count([d |
		decisions[d]
